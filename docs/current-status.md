...
- **MFL Blitz 0.4.1 (18): My Team and Board drafts.** Implemented, tested, signed and installed on Josh's iPhone on September 6. Build 18's launch check was blocked by the phone relocking; build 17 had launched successfully. Includes the concise schedule update label and Board Close/save/discard with visible draft recovery.
...
- **Physical device:** signed 0.4.1 (18) installed successfully; its launch attempt was denied because the phone was locked. Previous 0.4.0 (17) installed and launched after Josh unlocked it. Josh reported the My Team screen looked good and supplied a live schedule screenshot; that observation does not certify all opponent data or a full game week. Board's latest native composer, centered close prompt and readable Drafts entry were visually reviewed in Light appearance.
