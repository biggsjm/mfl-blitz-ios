...
- **MFL Blitz 0.4.1 (18): My Team and Board drafts.** Implemented, tested and signed. The Board revision is installed on Josh's iPhone; the final pre-merge compatibility rebuild still needs a reachable phone for reinstall. Build 18's launch check was blocked by the phone relocking; build 17 had launched successfully. Includes the concise schedule update label and Board Close/save/discard with visible draft recovery.
...
- **Physical device:** signed 0.4.1 (18) Board revision installed successfully; its launch attempt was denied because the phone was locked. The later compatibility reinstall failed because the phone was unreachable, not because of a build/signing error. Previous 0.4.0 (17) installed and launched after Josh unlocked it. Josh reported the My Team screen looked good and supplied a live schedule screenshot; that observation does not certify all opponent data or a full game week. Board's latest native composer, centered close prompt and readable Drafts entry were visually reviewed in Light and Dark appearances.
- **GitHub:** implementation commit [cd68b41](https://github.com/biggsjm/mfl-blitz-ios/commit/cd68b4123f2c96170836787df4be9b03623e6551) is in [PR #2](https://github.com/biggsjm/mfl-blitz-ios/pull/2). Merge requires both core and iOS checks for this increment, independently of the previous baseline. The PR and [CI history](https://github.com/biggsjm/mfl-blitz-ios/actions/workflows/ci.yml) retain the current merge/check result.
