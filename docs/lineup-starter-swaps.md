...
Keep visible copy minimal: short titles, player/slot arrows, and a brief save hint. Per-option arrows show the actual destinations instead of a paragraph explaining every possible outcome. VoiceOver retains explicit move descriptions.
