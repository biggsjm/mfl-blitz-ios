...
1. Owner: load build 28 successfully once, close/reopen on Wi-Fi/cellular, then test airplane-mode reopening and recovery. Compare current week/data with MFL before intended changes. Record phone time-to-content, not just synthetic timings.
