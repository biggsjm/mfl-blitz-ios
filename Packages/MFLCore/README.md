...
Run verification with `swift test` from this directory. Build 28 passes **91 tests in 12 suites** locally and all 91 in GitHub CI, including three new persistent-metadata regression functions. Exact final results are recorded in [current status](../../docs/current-status.md); app/UI and real-owner validation are separate. See [integration notes](../../docs/api-integration.md) and [contributing](../../CONTRIBUTING.md).
